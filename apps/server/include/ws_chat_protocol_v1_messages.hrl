...
-record(c2s_user_search, {msg_type = ?C2S_USER_SEARCH_TYPE, fname :: binary(), lname :: binary(), city :: binary(), group :: access_group() | undefined, affiliate_id :: non_neg_integer() | undefined}).
